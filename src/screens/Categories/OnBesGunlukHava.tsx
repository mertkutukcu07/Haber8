...
import HavaDurumuDetailOnBes from '../../Components/HavadurumuDetailOnbes';

const OnBesGunlukHava = ({navigation}) => {
  const onShare = async () => {
    try {
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.bodyC}>
          ...
          <View style={styles.tabbarC}>
            <View>
              <TouchableOpacity
                onPress={() => navigation.navigate('HavaDurumuScreen')}>
...
export default OnBesGunlukHava;
