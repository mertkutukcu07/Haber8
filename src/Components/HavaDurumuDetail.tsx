...
const HavaDurumuDetail = ({onPress}) => {
  const sehir = [
    'Bursa',
    'Antalya',
    'Kahramanmaraş',
            ...
            <View style={styles.bottomweatherC}>
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  onPress={onPress}>
                  <Text style={styles.saatTxt4}>
                    15 Günlük Hava Tahminini Gör
                  </Text>
...
export default HavaDurumuDetail;

const styles = StyleSheet.create({
  container: {
    flex: 1,
    minHeight: moderateVerticalScale(800),
  },
  bgi: {
    flex: 1,
    resizeMode: 'contain',
