...
import YerelHaberlerData from '../constants/data/YerelHaberlerData';

const YerelHaberler = ({onPress, onPressNewsDetail}) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerC}>
        <Text style={styles.headerTxt}>Yerel Haberler</Text>
        <TouchableOpacity onPress={onPress}>
          <Text style={styles.allnewsTxt}>Tümünü Göster</Text>
        </TouchableOpacity>
      </View>
      <FlatList
        data={YerelHaberlerData}
